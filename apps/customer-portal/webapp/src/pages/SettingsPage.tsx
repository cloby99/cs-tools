...
/**
 * Settings page for AI support capabilities.
 * Renders toggles for Novera chat and knowledge base suggestions.
 *
...
export default function SettingsPage(): JSX.Element {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
      {/* Page title - aligned with ProjectPage, AllCasesPage */}
      <Box sx={{ mb: 1 }}>
        <Typography variant="h4" gutterBottom>
          Settings
        </Typography>
        <Typography variant="body1" color="text.secondary">
          Manage AI support capabilities and preferences
        </Typography>
      </Box>

      {/* AI support header card - indigo/purple with alpha (like SupportOverviewCard chips) */}
      <Paper
        sx={{
          p: 2.5,
      ...
      {/* AI best practices card - warning/amber with alpha (like SupportOverviewCard) */}
      <Paper
        sx={{
          p: 2.5,
