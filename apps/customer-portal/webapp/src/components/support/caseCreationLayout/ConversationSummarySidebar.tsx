...
/**
 * Interface for conversation summary componenet.
 */
interface ConversationSummarySidebarProps {
  metadata?: any;
  isLoading: boolean;
}
 ...
 */
export const ConversationSummarySidebar = ({
  metadata,
  isLoading,
}: ConversationSummarySidebarProps): JSX.Element => (
