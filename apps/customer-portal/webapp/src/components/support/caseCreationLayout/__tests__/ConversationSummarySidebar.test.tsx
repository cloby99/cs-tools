...
import { ConversationSummarySidebar } from "../ConversationSummarySidebar";
...
describe("ConversationSummarySidebar", () => {
  const mockMetadata = {
    conversationSummary: {
  ...
  it("should render statistics when not loading", () => {
    render(
      <ConversationSummarySidebar metadata={mockMetadata} isLoading={false} />,
    );
  ...
  it("should render skeletons when loading", () => {
    render(
      <ConversationSummarySidebar metadata={mockMetadata} isLoading={true} />,
    );
